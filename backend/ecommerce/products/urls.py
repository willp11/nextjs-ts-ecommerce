...
urlpatterns = [
    path('product-get/<int:product>/', ProductGetView.as_view(), name='product_get'),
    ...
    # path('products-by-category-get-new/<int:category>/', ProductByCategoryViewNew.as_view(), name='products_by_category_get'),
]