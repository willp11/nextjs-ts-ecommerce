            ...
            <div className="w-full my-2 flex justify-start border-b border-gray-300 dark:border-gray-600">
                ...
                <div className="flex flex-col items-start justify-center ml-4">
                    ...
                    <div className="flex pt-2 items-center">
                        <button aria-label={`remove one more ${item.name} from cart`} onClick={()=>removeItem(item, 1)}>
                        ...
                        <button aria-label={`add one more ${item.name} to cart`} onClick={()=>addItem(item, 1)}>
