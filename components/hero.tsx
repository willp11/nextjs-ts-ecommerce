        ...
        <div className="w-full h-[calc(100vh-6.5rem)] md:h-[calc(100vh-10.25rem)] bg-[#f0f4ff] flex flex-col-reverse lg:flex-row px-4">
            <div className="w-full h-1/2 lg:w-1/2 xl:w-2/5 lg:h-full flex flex-col items-center justify-start lg:justify-center">
                ...
                <div className="mt-8 flex items-center justify-center lg:pb-8">
                    <button className="p-4 mr-2 w-[165px] border-2 border-blue-600 bg-blue-600 text-white font-semibold text-base sm:text-lg rounded-md hover:bg-blue-800 hover:border-blue-800 transition ease-in-out duration-300">
                        Browse Shop
                    </button>
                    <button className="p-4 ml-2 w-[165px] border-2 border-blue-600 text-blue-600 font-semibold text-base sm:text-lg rounded-md hover:bg-blue-300 hover:text-blue-800 transition ease-in-out duration-300">
                        Custom Jewelry
                    </button>
                </div>
            </div>
